...
config = {
    'gpu_list': [0,1,2,3],
    'exp_name': "test_run_binclass05x03_lovaszloss_cw_9w_190x200_final5",    #exp name
    ...
    'train_num_workers': 16,#16,#32,#4,
    'val_batch_size': 16,#4,#1,
    'val_num_workers': 16,#4,#2,
    'det_val_batch_size': 16,
    'reload_dataloaders_every_epoch': False,
    
    # dataset
    'root_path': '/mnt/yrfs/yanrong/pvc-80688cb9-3d14-45f4-9be0-f37238d68d83/personal/hefangzheng/data/grid_benckmark0808_300x300/new_dataset',
...
trainer = pl.Trainer(
                ...
                progress_bar_refresh_rate=200,#50,
