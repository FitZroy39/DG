...
config = {
    'gpu_list': [4,5,6,7],
    'exp_name': "test_run_pointpillar_10class0503_fine_lovaszloss_le1e3_da",    #exp name
    ...
    'root_path': '/private/personal/linyuqi/gpu12/mmsegmentation/data/pc_bev_10_classes0101',#'/ssd/linyuqi/pc_bev_rain/',#'/private/personal/linyuqi/gpu12/mmsegmentation/data/pc_bev_rain/',
    'train_dir': 'images_fine/training',
    #'lane_train_list': 'Lane_Port/train_list.txt',
    'val_dir': 'images_fine/validation',
