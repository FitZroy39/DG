...
def vis_single_result(pcd_path, save_path, gt_path, supplement_gt_path):
    ...
    supplement_gt_list = np.loadtxt(supplement_gt_path, dtype=np.int32)
    for grid in supplement_gt_list:
        idx = int(grid[0])
        idy = int(grid[1])
...
if __name__ == "__main__":
    ...
    gt_dir = "/mnt/yrfs/yanrong/pvc-80688cb9-3d14-45f4-9be0-f37238d68d83/personal/hefangzheng/data/grid_benckmark0808_300x300/7test"
    supplement_gt_dir = "/mnt/yrfs/yanrong/pvc-80688cb9-3d14-45f4-9be0-f37238d68d83/personal/hefangzheng/data/grid_benckmark0808_300x300/pedestrain/sup_pred_gt"
    pcd_dir = "/mnt/yrfs/yanrong/pvc-80688cb9-3d14-45f4-9be0-f37238d68d83/personal/hefangzheng/data/grid_benckmark0808_300x300/7test"
    save_path = '/mnt/yrfs/yanrong/pvc-80688cb9-3d14-45f4-9be0-f37238d68d83/personal/hefangzheng/data/grid_benckmark0808_300x300/supplement_gt_vis2'
    

    gt_dir_list = sorted(os.listdir(gt_dir))

    for bag_name in gt_dir_list[0:1]:
        gt_list = sorted(os.listdir(osp.join(gt_dir, bag_name, "gt")))


        for gt_file in gt_list: 
            gt_path = osp.join(gt_dir, bag_name, "gt",gt_file)
            pcd_path = osp.join(pcd_dir, bag_name, "pcd", gt_file.replace('.txt', '.pcd'))
            supplement_gt_path = osp.join(supplement_gt_dir, bag_name, gt_file)



            vis_single_result(pcd_path, save_path, gt_path, supplement_gt_path)
